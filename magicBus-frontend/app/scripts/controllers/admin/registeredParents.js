...
angular.module('magicBus')
    .controller('RegisteredParentsCtrl', function ($scope, parentService, $window, $route, $filter) {
       ...
       parentService.getRegisteredParents().
            ...
            Materialize.toast($filter('translate')('<strong>Ups!</strong> Registered parents could not be obtained.'), 4000,'red');
        });
